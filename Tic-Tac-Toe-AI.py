...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="cyan", relief=RAISED, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI BY KJ", bg="red", fg="#00FF00", font=("Lato", 25, "bold")).place(x=50, y=10)
        self.btn_1 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(1), state=DISABLED)
        self.btn_1.place(x=120,y=100)
        self.btn_2 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(2), state=DISABLED)
        self.btn_2.place(x=190,y=100)
        self.btn_3 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(3), state=DISABLED)
        self.btn_3.place(x=260,y=100)

        self.btn_4 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(4), state=DISABLED)
        self.btn_4.place(x=120,y=140)
        self.btn_5 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(5), state=DISABLED)
        self.btn_5.place(x=190,y=140)
        self.btn_6 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(6), state=DISABLED)
        self.btn_6.place(x=260,y=140)

        self.btn_7 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(7), state=DISABLED)
        self.btn_7.place(x=120,y=180)
        self.btn_8 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(8), state=DISABLED)
        self.btn_8.place(x=190,y=180)
        self.btn_9 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="black", activebackground="#262626", bd=3, command=lambda: self.__human_play(9), state=DISABLED)
        self.btn_9.place(x=260,y=180)

        self.activate_btn = [self.btn_1, self.btn_2, self.btn_3, self.btn_4, self.btn_5, self.btn_6, self.btn_7, self.btn_8, self.btn_9]

        self.machine_first_control = Button(self.make_canvas, text="AI Get First Chance", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=15, y=250)

        self.human_first_control = Button(self.make_canvas, text="You Get First Chance", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=220, y=250)
        ...
        self.reset_btn.place(x=190, y=300)
